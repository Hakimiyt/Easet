...
if (isset($_POST["bppaedit"])) {
    ...
    $sqlUpdate = "UPDATE tbl_semakan SET nama = '$nama', jenis_aset = '$jenis_aset', kategori = '$kategori', no_siri = '$no_siri', tempat_rosak = '$tempat_rosak', tarikh_rosak = '$tarikh_rosak', userterakhir = '$userterakhir', ulasan = '$ulasan' WHERE no_id = '$no_id'";
...
if (isset($_POST["staffedit"])) {
    ...
    $sqlUpdate = "UPDATE tbl_semakan SET nama = '$nama', jenis_aset = '$jenis_aset', kategori = '$kategori', no_siri = '$no_siri', tempat_rosak = '$tempat_rosak', tarikh_rosak = '$tarikh_rosak', userterakhir = '$userterakhir', ulasan = '$ulasan', lulus_jabatan = '$lulus_jabatan' WHERE no_id = '$no_id'";
