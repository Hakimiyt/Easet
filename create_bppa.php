...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_bppa(id_pegawai, ic, password, nama, emel, notel, kategori) 
                            VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssss", $id_pegawai, $ic, $password, $nama, $emel, $notel, $kategori);
        ...
        <div class="container">
            <div class="form-container">
                ...
                <form action="create_bppa.php" method="POST">
                    ...
                    <div class="form-group">
                    <select name="kategori" id="" class="form-group" required>
