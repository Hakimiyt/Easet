...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_daftar (id_pegawai, ic, password, nama, emel, notel) 
                            VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $id_pegawai, $ic, $password, $nama, $emel, $notel);
...
<body>
    <nav class="navbar">
        <div class="container">
            ...
            <ul class="navbar-nav">
                <li>
                    <a class="button" href="login_user.php">Kembali</a>
                </li>
            </ul>
        </div>
    </nav>
